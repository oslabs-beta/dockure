...
promContainerController.startProm = (req, res, next) => {  
    ...
    exec(`docker run --name prometheus -p 9090:9090  -v ${path.join(__dirname, '../assets/promConfigFile.yaml')}:/etc/prometheus/prometheus.yml  prom/prometheus`, (error, stdout, stderr) => {
